...
<html>
	...
	<!--[if !IE]><!--><body><!--<![endif]-->
		<div id="bloc_page">
            ...
            <section>
				<div id ="full">
					<div class="headerX">PROVINCIALE 2 DAMES</div> 
					<div class="bodyX">
					<br>
					<article>
					<div id="portail">
					...
					<p><img src="<?php echo $location . 'images/equipes/' . substr(basename($_SERVER['PHP_SELF']),0,3) . '.jpg'?>" alt="" /></p>
					
					<p><font color="#780000">
					<?php
					
					/* $url = "http://www.portailaif.be/vbClassement.php?vb_Env=vbbt&div=" . substr(basename($_SERVER['PHP_SELF']),0,2) . "D&mat=1064";

...
<html>
	...
	<!--[if !IE]><!--><body><!--<![endif]-->
		<div id="bloc_page">
            ...
            <section>
				<div id ="full">
					<div class="headerX">PROVINCIALE 4 B DAMES</div> 
					<div class="bodyX">
					<br>
					<article>
					<div id="portail">
					...
					/* $url = "http://www.portailaif.be/vbClassement.php?vb_Env=vbbt&div=" . substr(basename($_SERVER['PHP_SELF']),0,3) . "D&mat=1064";
